...
public class Feat implements Parcelable {
    ...
    public Feat(String title, String poster_path, String release_date, int movie_id, String vote_average, String movie_overview, String original_language) {
        this.title = title;
    ...
    public static final Creator<Feat> CREATOR = new Creator<Feat>() {
        @Override
